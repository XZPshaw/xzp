...
function Judge(){
    ...
    this.inputCheckoutMaxCount = Math.max(checkoutMaximumCount, 1);
...
Judge.prototype.finalize = function(){
    this.bpm = this.rhythm_bpm;
    this.checkoutMaximumCount = this.inputCheckoutMaxCount;
    this.beatInterval = 60.0 / this.bpm * 1000.0 * 4.0 / this.barDivisor;
...
Judge.prototype.finalizeWithGridBaseMovement = function(){
    this.checkoutMaximumCount = 1;
    this.beatInterval = 60.0 / this.bpm * 1000.0 * 4.0 / 8;
}
...
(function(){
    ...
    Game_Map.prototype.finalizeWithGridBaseMovement = function(){
        this.UI.finalize();
        //this.isStarted = false;
        //this.update = this.updateBeforeInit;
    };
    ...
    Game_Map.prototype.updateAfterStarted = function(sceneActive){
        /*
        if (this.originalUpdate === undefined){
            this.originalUpdate = this.update;
        }*/
    ...
    Game_Player.prototype.finalize = function(){
        this.judge.finalize();
        this._moveSpeed = 3.5;              //Move fast
        this.moveByInput = this.originalMoveFunction;
        //this.moveByInput = function(){};
    };

    Game_Player.prototype.finalizeWithGridBaseMovement = function(){
        //this.judge.finalize();
        this.judge.finalizeWithGridBaseMovement();
        //this._moveSpeed = 5.5;              //Move fast
        //this.moveByInput = this.moveByWalking;
        //this.moveByInput = function(){};
        ...
        /*
        this._moveSpeed = 5.5;              //Move fast
        this.judge.barDivisor = 10000;
        this.judge.perfectCutoff = 2500;
        this.judge.missCutoff = 5000;
        this.judge.checkoutMaximumCount = 1;
        */
    };

    
    Game_Player.prototype.finalizeNormalMove = function(){
        this.judge.finalize();
        this.moveByInput = function(){};
    };
...
var flameUpdate = function(isOn, SEpitch){
    if(isOn){
        ...
        //AudioManager.playSe({name: "Fire1", pan:0, pitch: SEpitch, volume: 5});
    }else{
        var key = [$gameMap._mapId, this._eventId, "A"];
        $gameSelfSwitches.setValue(key,true);
        key = [$gameMap._mapId, this._eventId, "B"];
...
var HealPotionUpdate = function(isOn){
    if(isOn){
        var key = [$gameMap._mapId, this._eventId, "A"];
        $gameSelfSwitches.setValue(key,false);
        key = [$gameMap._mapId, this._eventId, "B"];
