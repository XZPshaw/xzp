...
StageManager.prototype.finalize = function(){
    ...
    //used for rhythm based movement
    $gamePlayer.finalize();
    $gameMap.finalize();
    //$gamePlayer.finalizeWithGridBaseMovement();
    //$gameMap.finalizeWithGridBaseMovement();
}

StageManager.prototype.ChangeToNormal4DirMove = function(){
    $gamePlayer.finalize();
    $gameMap.finalize();
}

StageManager.prototype.ChangeToGridBaseMovement = function(){
    //this.bgmAudio.pause();
    //this.bgmAudio.currentTime = 0;
    //$gamePlayer.finalize();
...
StageManager.prototype.changeBgmSong = function (songName) {
    this.bgmAudio.pause();
    this.bgmAudio.currentTime = 0;
