...
function UINotes(){
    ...
    for(var i = 0;i<UI_poolSize;i++){
        $gameScreen.showPicture(i+2,"UI",1, -100,620,100,100,255,0);    //Create note's picture
        $gameScreen.showPicture(i+2+UI_poolSize,"UI",1,916,620,100,100,255,0);
...
UIManager.prototype.CreatHeart =function(){
    ...
    $gameScreen.showPicture(1,"heart",1,620,620,scaling,scaling,255,0);
}
...
UIManager.prototype.finalizeWithGridBaseMovement = function(){
    $gameScreen.clearPictures();
}